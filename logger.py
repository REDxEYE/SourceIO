...
if loaded_as_addon() and running_in_blender():
    ...
    from .blender_bindings.utils.logging_impl import BPYLoggingManager as _BPYLoggingManager
else:
    from .library.utils.logging_stub import BPYLoggingManager as _BPYLoggingManager
