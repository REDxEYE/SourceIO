...
logger = log_manager.get_logger('Portal2RevolutionDetector')


class Portal2RevolutionDetector(Source1Detector):
    @classmethod
    def scan(cls, path: TinyPath) -> list[ContentProvider]:
        ...
        portal2_mod_gi_path = portal2_root / "revolution/gameinfo.txt"
