...
from ...library.source1.mdl.v2531.mdl_file import MdlV2531 as S1MdlV2531
...
class Source1ModelContainer(ModelContainer):
    def __init__(self, mdl: Union[S1MdlV36, S1MdlV44, S1MdlV49, S1MdlV2531], vvd: Optional[Vvd], vtx: Vtx, file_list):

        super().__init__()
        from ..source1.mdl import FileImport

        self.mdl: Union[S1MdlV36, S1MdlV44, S1MdlV49, S1MdlV2531] = mdl
        self.vvd: Vvd = vvd
        self.vtx: Vtx = vtx
