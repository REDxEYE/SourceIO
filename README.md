[![Blender](https://img.shields.io/badge/Blender->=_3.6-orange?logo=blender&logoColor=white)](https://www.blender.org/download)
...
# SourceIO
SourceIO is a Blender(3.6+) addon for importing source engine textures/models/maps
