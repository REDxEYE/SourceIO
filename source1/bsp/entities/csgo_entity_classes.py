...
class Studiomodel(ToggleDraw, Shadow):
    def __init__(self):
...
class Breakable(Targetname, Reflection, Shadow, DamageFilter):
    def __init__(self):
        super(Targetname).__init__()
        super(Reflection).__init__()
        super(Shadow).__init__()
...
class BaseNPC(Angles, ResponseContext, ToggleDraw, Targetname, DamageFilter, Shadow, RenderFields):
    def __init__(self):
...
class worldbase(Base):
    def __init__(self):
        ...
        self.skyname = "sky_dust"  # Type: string
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.skyname = entity_data.get('skyname', "sky_dust")  # Type: string
...
class env_sun(Targetname, Angles):
    def __init__(self):
        ...
        self.glowDistanceScale = 0.99  # Type: float
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.glowDistanceScale = float(entity_data.get('glowdistancescale', 0.99))  # Type: float
...
class func_wall(Targetname, Shadow, RenderFields, Global):
    def __init__(self):
        super(RenderFields).__init__()
        super(Targetname).__init__()
        super(Shadow).__init__()
...
class func_brush(PaintableBrush, EnableDisable, Global, Origin, Targetname, Shadow, Inputfilter, Parentname,
                 RenderFields, Reflection):
    def __init__(self):
        super(RenderFields).__init__()
...
class env_fog_controller(Targetname, SystemLevelChoice, Angles):
    ...
    def __init__(self):
        ...
        self.ZoomFogScale = 1  # Type: float
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.ZoomFogScale = float(entity_data.get('zoomfogscale', 1))  # Type: float
...
class env_sprite(Targetname, SystemLevelChoice, Parentname, RenderFields):
    def __init__(self):
        super(RenderFields).__init__()
        super(Targetname).__init__()
        super(SystemLevelChoice).__init__()
...
class env_sprite_clientside(Angles, env_sprite):
    def __init__(self):
        super(env_sprite).__init__()
        super(Angles).__init__()
        self.origin = [0, 0, 0]
...
class point_worldtext(Targetname, Angles, Parentname):
    def __init__(self):
        super(Targetname).__init__()
        super(Angles).__init__()
        super(Parentname).__init__()
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.message = entity_data.get('message', None)  # Type: string
        instance.textsize = float(entity_data.get('textsize', 10))  # Type: float
        instance.color = parse_int_vector(entity_data.get('color', "255 255 255"))  # Type: color255


class point_spotlight(SystemLevelChoice, Angles, Targetname, Parentname, RenderFields):
...
class phys_ragdollmagnet(Targetname, EnableDisable, Angles, Parentname):
    icon_sprite = "editor/info_target.vmt"
...
class info_node_air_hint(Targetname, Angles, HintNode):
...
class env_cascade_light(Targetname, EnableDisable):
    ...
    def __init__(self):
        ...
        self.uselightenvangles = 1  # Type: boolean
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.uselightenvangles = entity_data.get('uselightenvangles', None)  # Type: boolean
...
class func_rotating(Angles, Origin, Targetname, Shadow, Parentname, RenderFields, Reflection):
    def __init__(self):
        super(RenderFields).__init__()
        super(Angles).__init__()
        super(Origin).__init__()
...
class func_platrot(Angles, Origin, Targetname, Shadow, BasePlat, Parentname, RenderFields, Reflection):
    def __init__(self):
        super(RenderFields).__init__()
        super(Angles).__init__()
        super(Origin).__init__()
...
class move_keyframed(Targetname, Mover, KeyFrame, Parentname):
    def __init__(self):
        super(Targetname).__init__()
...
class move_track(Targetname, Mover, KeyFrame, Parentname):
    def __init__(self):
        super(Targetname).__init__()
        super(Mover).__init__()
        super(KeyFrame).__init__()
...
class func_button(Origin, Button, Targetname, DamageFilter, Parentname, RenderFields):
    def __init__(self):
        super(RenderFields).__init__()
        super(Origin).__init__()
        ...
        self._minlight = None  # Type: string
        self.min_use_angle = 0.8  # Type: float
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance._minlight = entity_data.get('_minlight', None)  # Type: string
        instance.min_use_angle = float(entity_data.get('min_use_angle', 0.8))  # Type: float


class func_rot_button(EnableDisable, Global, Angles, Origin, Button, Targetname, Parentname):
    def __init__(self):
        super(EnableDisable).__init__()
        super(Global).__init__()
        super(Angles).__init__()
...
class momentary_rot_button(Angles, Origin, Targetname, Parentname, RenderFields):
    def __init__(self):
        super(RenderFields).__init__()
        super(Angles).__init__()
        super(Origin).__init__()
...
class Door(Global, Targetname, Shadow, Parentname, RenderFields, Reflection):
    def __init__(self):
        super(RenderFields).__init__()
        super(Global).__init__()
        super(Targetname).__init__()
...
class PropDoorRotating(Global, Angles, Studiomodel, Targetname, BaseFadeProp, Parentname):
    def __init__(self):
        ...
        self.glowdist = 1024  # Type: integer
        self.glowenabled = None  # Type: boolean
        self.glowcolor = [255, 255, 255]  # Type: color255
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.glowdist = parse_source_value(entity_data.get('glowdist', 1024))  # Type: integer
        instance.glowenabled = entity_data.get('glowenabled', None)  # Type: boolean
        instance.glowcolor = parse_int_vector(entity_data.get('glowcolor', "255 255 255"))  # Type: color255


class prop_door_rotating(PropDoorRotating):
    def __init__(self):
        super(PropDoorRotating).__init__()
        self.origin = [0, 0, 0]

    @staticmethod
    def from_dict(instance, entity_data: dict):
        PropDoorRotating.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
...
class func_dustmotes(Targetname, BModelParticleSpawner):
    def __init__(self):
        ...
        self.AffectedByWind = 1  # Type: boolean
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.AffectedByWind = entity_data.get('affectedbywind', None)  # Type: boolean
...
class point_proximity_sensor(Targetname, EnableDisable, Angles, Parentname):
    def __init__(self):
        super(Targetname).__init__()
        super(EnableDisable).__init__()
        super(Angles).__init__()
...
class prop_static_base(SystemLevelChoice, Angles, Shadow, Reflection):
    def __init__(self):
        super(SystemLevelChoice).__init__()
        super(Angles).__init__()
        super(Shadow).__init__()
        ...
        self.renderamt = 255  # Type: integer
        self.rendercolor = [255, 255, 255]  # Type: color255
        self.enablelightbounce = None  # Type: boolean
        self.preventpropcombine = None  # Type: boolean
        self.uniformscale = 1  # Type: float
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.renderamt = parse_source_value(entity_data.get('renderamt', 255))  # Type: integer
        instance.rendercolor = parse_int_vector(entity_data.get('rendercolor', "255 255 255"))  # Type: color255
        instance.enablelightbounce = entity_data.get('enablelightbounce', None)  # Type: boolean
        instance.preventpropcombine = entity_data.get('preventpropcombine', None)  # Type: boolean
        instance.uniformscale = float(entity_data.get('uniformscale', 1))  # Type: float


class prop_dynamic_base(Global, Angles, SystemLevelChoice, BreakableProp, BaseFadeProp, Parentname, RenderFields,
                        Studiomodel):
    def __init__(self):
        super(Studiomodel).__init__()
        ...
        self.is_autoaim_target = None  # Type: boolean
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.is_autoaim_target = entity_data.get('is_autoaim_target', None)  # Type: boolean
...
class BasePropPhysics(Global, SystemLevelChoice, Angles, Studiomodel, BreakableProp, BaseFadeProp):
    def __init__(self):
        super(Studiomodel).__init__()
        super(BreakableProp).__init__()
        super(Global).__init__()
...
class prop_ragdoll(EnableDisable, SystemLevelChoice, Angles, Studiomodel, Targetname, BaseFadeProp):
    def __init__(self):
        super(Studiomodel).__init__()
        super(EnableDisable).__init__()
        super(SystemLevelChoice).__init__()
...
class func_illusionary(Origin, Targetname, Shadow, Parentname, RenderFields):
    def __init__(self):
        super(RenderFields).__init__()
        super(Origin).__init__()
        super(Targetname).__init__()
...
class Trackchange(Global, Targetname, PlatSounds, Parentname, RenderFields):
    def __init__(self):
        super(RenderFields).__init__()
        super(Global).__init__()
        super(Targetname).__init__()
...
class BaseTrain(Global, Origin, Targetname, Shadow, Parentname, RenderFields, Reflection):
    def __init__(self):
        super(RenderFields).__init__()
        super(Global).__init__()
        super(Origin).__init__()
...
class trigger_soundoperator(Trigger):
    def __init__(self):
        super(Trigger).__init__()
        self.sosvar = None  # Type: choices

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Trigger.from_dict(instance, entity_data)
        instance.sosvar = entity_data.get('sosvar', None)  # Type: choices
...
class trigger_push(Trigger):
    def __init__(self):
        ...
        self.OnlyFallingPlayers = None  # Type: boolean
        self.FallingSpeedThreshold = -150  # Type: float
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.OnlyFallingPlayers = entity_data.get('onlyfallingplayers', None)  # Type: boolean
        instance.FallingSpeedThreshold = float(entity_data.get('fallingspeedthreshold', -150))  # Type: float
...
class trigger_teleport(Trigger):
    def __init__(self):
        ...
        self.CheckDestIfClearForPlayer = None  # Type: boolean
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.CheckDestIfClearForPlayer = entity_data.get('checkdestifclearforplayer', None)  # Type: boolean
...
class logic_eventlistener(Targetname):
    def __init__(self):
        ...
        self.FetchEventData = None  # Type: choices
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.FetchEventData = entity_data.get('fetcheventdata', None)  # Type: choices
...
class logic_eventlistener_itemequip(Targetname):
    def __init__(self):
        ...
        self.WeaponClassname = None  # Type: string
        self.IsEnabled = "CHOICES NOT SUPPORTED"  # Type: choices
        self.TeamNum = "CHOICES NOT SUPPORTED"  # Type: choices
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.WeaponClassname = entity_data.get('weaponclassname', None)  # Type: string
        instance.IsEnabled = entity_data.get('isenabled', "CHOICES NOT SUPPORTED")  # Type: choices
        instance.TeamNum = entity_data.get('teamnum', "CHOICES NOT SUPPORTED")  # Type: choices
...
class beam_spotlight(SystemLevelChoice, Angles, Targetname, Parentname, RenderFields):
    model = "models/editor/cone_helper.mdl"
...
class env_instructor_hint(Targetname):
    def __init__(self):
        ...
        self.hint_local_player_only = No  # Type: boolean
...
class prop_hallucination(Targetname, Angles, Parentname, Studiomodel):
    def __init__(self):
        super(Studiomodel).__init__()
        super(Targetname).__init__()
        super(Angles).__init__()
        super(Parentname).__init__()
        self.origin = [0, 0, 0]
        self.EnabledChance = 100.0  # Type: float
        self.VisibleTime = 0.215  # Type: float
        self.RechargeTime = 0.0  # Type: float
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Studiomodel.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.EnabledChance = float(entity_data.get('enabledchance', 100.0))  # Type: float
        instance.VisibleTime = float(entity_data.get('visibletime', 0.215))  # Type: float
        instance.RechargeTime = float(entity_data.get('rechargetime', 0.0))  # Type: float
...
class BaseTank(Global, Angles, Origin, Targetname, Shadow, Parentname, RenderFields):
    def __init__(self):
        super(RenderFields).__init__()
        super(Global).__init__()
        super(Angles).__init__()
        ...
        self.LeadTarget = No  # Type: boolean
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.LeadTarget = entity_data.get('leadtarget', None)  # Type: boolean
...
class Weapon(Targetname, Angles, RenderFields):
    def __init__(self):
        super(RenderFields).__init__()
        super(Targetname).__init__()
        super(Angles).__init__()
        self.CanBePickedUp = 1  # Type: boolean
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Angles.from_dict(instance, entity_data)
        RenderFields.from_dict(instance, entity_data)
        instance.CanBePickedUp = entity_data.get('canbepickedup', None)  # Type: boolean
...
class prop_dynamic_glow(prop_dynamic):
    def __init__(self):
        ...
        self.origin = [0, 0, 0]
        self.glowdist = 1024  # Type: integer
        self.glowenabled = 1  # Type: boolean
        self.glowcolor = [255, 255, 255]  # Type: color255
        self.glowstyle = None  # Type: choices
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.glowenabled = entity_data.get('glowenabled', None)  # Type: boolean
        instance.glowcolor = parse_int_vector(entity_data.get('glowcolor', "255 255 255"))  # Type: color255
        instance.glowstyle = entity_data.get('glowstyle', None)  # Type: choices


class info_player_counterterrorist(Targetname, Angles):
    model = "models/player/ctm_st6.mdl"
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Angles.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.priority = parse_source_value(entity_data.get('priority', 0))  # Type: integer
        instance.enabled = entity_data.get('enabled', None)  # Type: boolean


class info_player_terrorist(Targetname, Angles):
    model = "models/player/tm_phoenix.mdl"
...
class info_armsrace_counterterrorist(Targetname, Angles):
    model = "models/player/ctm_idf_variantb.mdl"
...
class info_armsrace_terrorist(Targetname, Angles):
    model = "models/player/tm_leet_varianta.mdl"
...
class info_enemy_terrorist_spawn(Targetname, Angles):
    ...
    def __init__(self):
        ...
        self.priority = None  # Type: integer
        self.enabled = 1  # Type: boolean
        self.model_to_use = None  # Type: studio
        self.weapons_to_give = "glock"  # Type: string
        self.armor_to_give = "CHOICES NOT SUPPORTED"  # Type: choices
        self.start_asleep = 1  # Type: boolean
        self.default_behavior = None  # Type: choices
        self.bot_difficulty = None  # Type: integer
        self.is_agressive = None  # Type: boolean
        self.hide_radius = 1000  # Type: float
        self.behavior_tree_file = None  # Type: string
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.priority = parse_source_value(entity_data.get('priority', 0))  # Type: integer
        instance.enabled = entity_data.get('enabled', None)  # Type: boolean
        instance.model_to_use = entity_data.get('model_to_use', None)  # Type: studio
        instance.weapons_to_give = entity_data.get('weapons_to_give', "glock")  # Type: string
        instance.armor_to_give = entity_data.get('armor_to_give', "CHOICES NOT SUPPORTED")  # Type: choices
        instance.start_asleep = entity_data.get('start_asleep', None)  # Type: boolean
        instance.default_behavior = entity_data.get('default_behavior', None)  # Type: choices
        instance.bot_difficulty = parse_source_value(entity_data.get('bot_difficulty', 0))  # Type: integer
        instance.is_agressive = entity_data.get('is_agressive', None)  # Type: boolean
        instance.hide_radius = float(entity_data.get('hide_radius', 1000))  # Type: float
        instance.behavior_tree_file = entity_data.get('behavior_tree_file', None)  # Type: string
...
class info_survival_crate_spawn(Targetname, Angles):
    ...
    def __init__(self):
        ...
        super(Angles).__init__()
        self.origin = [0, 0, 0]
        self.bonuscrate = None  # Type: boolean
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Angles.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.bonuscrate = entity_data.get('bonuscrate', None)  # Type: boolean
...
class hostage_entity(Targetname, Angles):
    ...
    def __init__(self):
        ...
        super(Angles).__init__()
        self.origin = [0, 0, 0]
        self.HostageType = None  # Type: choices
        self.HostageSpawnRandomFactor = 1  # Type: integer
        self.HostageSpawnExclusionGroup1 = None  # Type: choices
        self.HostageSpawnExclusionGroup2 = None  # Type: choices
        self.HostageSpawnExclusionGroup3 = None  # Type: choices
        self.HostageSpawnExclusionGroup4 = None  # Type: choices
        self.HostageSpawnExclusionGroup5 = None  # Type: choices
        self.HostageSpawnExclusionGroup6 = None  # Type: choices
        self.HostageSpawnExclusionGroup7 = None  # Type: choices
        self.HostageSpawnExclusionGroup8 = None  # Type: choices
        self.HostageSpawnExclusionGroup9 = None  # Type: choices
        self.HostageSpawnExclusionGroup10 = None  # Type: choices
        self.HostageSpawnExclusionGroup11 = None  # Type: choices
        self.HostageSpawnExclusionGroup12 = None  # Type: choices
        self.HostageSpawnExclusionGroup13 = None  # Type: choices
        self.HostageSpawnExclusionGroup14 = None  # Type: choices
        self.HostageSpawnExclusionGroup15 = None  # Type: choices
        self.HostageSpawnExclusionGroup16 = None  # Type: choices
        self.HostageSpawnExclusionGroup17 = None  # Type: choices
        self.HostageSpawnExclusionGroup18 = None  # Type: choices
        self.HostageSpawnExclusionGroup19 = None  # Type: choices
        self.HostageSpawnExclusionGroup20 = None  # Type: choices
        self.HostageSpawnExclusionGroup21 = None  # Type: choices
        self.HostageSpawnExclusionGroup22 = None  # Type: choices
        self.HostageSpawnExclusionGroup23 = None  # Type: choices
        self.HostageSpawnExclusionGroup24 = None  # Type: choices
        self.HostageSpawnExclusionGroup25 = None  # Type: choices
        self.HostageSpawnExclusionGroup26 = None  # Type: choices
        self.HostageSpawnExclusionGroup27 = None  # Type: choices
        self.HostageSpawnExclusionGroup28 = None  # Type: choices
        self.HostageSpawnExclusionGroup29 = None  # Type: choices
        self.HostageSpawnExclusionGroup30 = None  # Type: choices
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Angles.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.HostageType = entity_data.get('hostagetype', None)  # Type: choices
        instance.HostageSpawnRandomFactor = parse_source_value(
            entity_data.get('hostagespawnrandomfactor', 1))  # Type: integer
        instance.HostageSpawnExclusionGroup1 = entity_data.get('hostagespawnexclusiongroup1', None)  # Type: choices
        instance.HostageSpawnExclusionGroup2 = entity_data.get('hostagespawnexclusiongroup2', None)  # Type: choices
        instance.HostageSpawnExclusionGroup3 = entity_data.get('hostagespawnexclusiongroup3', None)  # Type: choices
        instance.HostageSpawnExclusionGroup4 = entity_data.get('hostagespawnexclusiongroup4', None)  # Type: choices
        instance.HostageSpawnExclusionGroup5 = entity_data.get('hostagespawnexclusiongroup5', None)  # Type: choices
        instance.HostageSpawnExclusionGroup6 = entity_data.get('hostagespawnexclusiongroup6', None)  # Type: choices
        instance.HostageSpawnExclusionGroup7 = entity_data.get('hostagespawnexclusiongroup7', None)  # Type: choices
        instance.HostageSpawnExclusionGroup8 = entity_data.get('hostagespawnexclusiongroup8', None)  # Type: choices
        instance.HostageSpawnExclusionGroup9 = entity_data.get('hostagespawnexclusiongroup9', None)  # Type: choices
        instance.HostageSpawnExclusionGroup10 = entity_data.get('hostagespawnexclusiongroup10', None)  # Type: choices
        instance.HostageSpawnExclusionGroup11 = entity_data.get('hostagespawnexclusiongroup11', None)  # Type: choices
        instance.HostageSpawnExclusionGroup12 = entity_data.get('hostagespawnexclusiongroup12', None)  # Type: choices
        instance.HostageSpawnExclusionGroup13 = entity_data.get('hostagespawnexclusiongroup13', None)  # Type: choices
        instance.HostageSpawnExclusionGroup14 = entity_data.get('hostagespawnexclusiongroup14', None)  # Type: choices
        instance.HostageSpawnExclusionGroup15 = entity_data.get('hostagespawnexclusiongroup15', None)  # Type: choices
        instance.HostageSpawnExclusionGroup16 = entity_data.get('hostagespawnexclusiongroup16', None)  # Type: choices
        instance.HostageSpawnExclusionGroup17 = entity_data.get('hostagespawnexclusiongroup17', None)  # Type: choices
        instance.HostageSpawnExclusionGroup18 = entity_data.get('hostagespawnexclusiongroup18', None)  # Type: choices
        instance.HostageSpawnExclusionGroup19 = entity_data.get('hostagespawnexclusiongroup19', None)  # Type: choices
        instance.HostageSpawnExclusionGroup20 = entity_data.get('hostagespawnexclusiongroup20', None)  # Type: choices
        instance.HostageSpawnExclusionGroup21 = entity_data.get('hostagespawnexclusiongroup21', None)  # Type: choices
        instance.HostageSpawnExclusionGroup22 = entity_data.get('hostagespawnexclusiongroup22', None)  # Type: choices
        instance.HostageSpawnExclusionGroup23 = entity_data.get('hostagespawnexclusiongroup23', None)  # Type: choices
        instance.HostageSpawnExclusionGroup24 = entity_data.get('hostagespawnexclusiongroup24', None)  # Type: choices
        instance.HostageSpawnExclusionGroup25 = entity_data.get('hostagespawnexclusiongroup25', None)  # Type: choices
        instance.HostageSpawnExclusionGroup26 = entity_data.get('hostagespawnexclusiongroup26', None)  # Type: choices
        instance.HostageSpawnExclusionGroup27 = entity_data.get('hostagespawnexclusiongroup27', None)  # Type: choices
        instance.HostageSpawnExclusionGroup28 = entity_data.get('hostagespawnexclusiongroup28', None)  # Type: choices
        instance.HostageSpawnExclusionGroup29 = entity_data.get('hostagespawnexclusiongroup29', None)  # Type: choices
        instance.HostageSpawnExclusionGroup30 = entity_data.get('hostagespawnexclusiongroup30', None)  # Type: choices
...
class info_hostage_spawn(hostage_entity):
    ...
    def __init__(self):
        super(hostage_entity).__init__()
        self.origin = [0, 0, 0]

    @staticmethod
    def from_dict(instance, entity_data: dict):
        hostage_entity.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
...
class info_view_parameters(Angles):
    def __init__(self):
        super(Angles).__init__()
        self.origin = [0, 0, 0]
        self.ViewMode = None  # Type: choices

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Angles.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.ViewMode = entity_data.get('viewmode', None)  # Type: choices
...
class info_map_parameters(Targetname, Angles):
    def __init__(self):
        ...
        super(Angles).__init__()
        self.origin = [0, 0, 0]
        self.buying = None  # Type: choices
        self.bombradius = 500  # Type: float
        self.petpopulation = None  # Type: float
        self.usenormalspawnsfordm = None  # Type: boolean
        self.disableautogenerateddmspawns = None  # Type: boolean
        self.botmaxvisiondistance = -1  # Type: float
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Angles.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.buying = entity_data.get('buying', None)  # Type: choices
        instance.bombradius = float(entity_data.get('bombradius', 500))  # Type: float
        instance.petpopulation = float(entity_data.get('petpopulation', 0))  # Type: float
        instance.usenormalspawnsfordm = entity_data.get('usenormalspawnsfordm', None)  # Type: boolean
        instance.disableautogenerateddmspawns = entity_data.get('disableautogenerateddmspawns', None)  # Type: boolean
        instance.botmaxvisiondistance = float(entity_data.get('botmaxvisiondistance', -1))  # Type: float
...
class weapon_ak47(Weapon):
    model = "models/weapons/w_rif_ak47_dropped.mdl"
...
class weapon_aug(Weapon):
    model = "models/weapons/w_rif_aug_dropped.mdl"
...
class weapon_awp(Weapon):
    model = "models/weapons/w_snip_awp_dropped.mdl"
...
class weapon_bizon(Weapon):
    model = "models/weapons/w_smg_bizon_dropped.mdl"
...
class weapon_cz75a(Weapon):
    model = "models/weapons/w_pist_cz_75_dropped.mdl"
...
class weapon_deagle(Weapon):
    model = "models/weapons/w_pist_deagle_dropped.mdl"
...
class weapon_decoy(Weapon):
    model = "models/weapons/w_eq_decoy_dropped.mdl"
...
class weapon_famas(Weapon):
    model = "models/weapons/w_rif_famas_dropped.mdl"
...
class weapon_fiveseven(Weapon):
    model = "models/weapons/w_pist_fiveseven_dropped.mdl"
...
class weapon_g3sg1(Weapon):
    model = "models/weapons/w_snip_g3sg1_dropped.mdl"
...
class weapon_galilar(Weapon):
    model = "models/weapons/w_rif_galilar_dropped.mdl"
...
class weapon_glock(Weapon):
    model = "models/weapons/w_pist_glock18_dropped.mdl"
...
class weapon_hegrenade(Weapon):
    model = "models/weapons/w_eq_fraggrenade_dropped.mdl"
...
class weapon_hkp2000(Weapon):
    model = "models/weapons/w_pist_hkp2000_dropped.mdl"
...
class weapon_knife(Weapon):
    model = "models/weapons/w_knife.mdl"
...
class weapon_m4a1(Weapon):
    model = "models/weapons/w_rif_m4a1_dropped.mdl"
...
class weapon_m4a1_silencer(Weapon):
    model = "models/weapons/w_rif_m4a1_s_dropped.mdl"
...
class weapon_m249(Weapon):
    model = "models/weapons/w_mach_m249_dropped.mdl"
...
class weapon_mac10(Weapon):
    model = "models/weapons/w_smg_mac10_dropped.mdl"
...
class weapon_mag7(Weapon):
    model = "models/weapons/w_shot_mag7_dropped.mdl"
...
class weapon_molotov(Weapon):
    model = "models/weapons/w_eq_molotov_dropped.mdl"
...
class weapon_mp7(Weapon):
    model = "models/weapons/w_smg_mp7_dropped.mdl"
...
class weapon_mp9(Weapon):
    model = "models/weapons/w_smg_mp9_dropped.mdl"
...
class weapon_negev(Weapon):
    model = "models/weapons/w_mach_negev_dropped.mdl"
...
class weapon_nova(Weapon):
    model = "models/weapons/w_shot_nova_dropped.mdl"
...
class weapon_p90(Weapon):
    model = "models/weapons/w_smg_p90_dropped.mdl"
...
class weapon_p250(Weapon):
    model = "models/weapons/w_pist_p250_dropped.mdl"
...
class weapon_revolver(Weapon):
    model = "models/weapons/w_pist_revolver_dropped.mdl"
...
class weapon_sawedoff(Weapon):
    model = "models/weapons/w_shot_sawedoff_dropped.mdl"
...
class weapon_sg556(Weapon):
    model = "models/weapons/w_rif_sg556_dropped.mdl"
...
class weapon_tagrenade(Weapon):
    model = "models/weapons/w_eq_sensorgrenade_dropped.mdl"
...
class weapon_ssg08(Weapon):
    model = "models/weapons/w_snip_ssg08_dropped.mdl"
...
class weapon_tec9(Weapon):
    model = "models/weapons/w_pist_tec9_dropped.mdl"
...
class weapon_ump45(Weapon):
    model = "models/weapons/w_smg_ump45_dropped.mdl"
...
class weapon_usp_silencer(Weapon):
    model = "models/weapons/w_pist_223_dropped.mdl"
...
class weapon_xm1014(Weapon):
    model = "models/weapons/w_shot_xm1014_dropped.mdl"
...
class weapon_scar20(Weapon):
    model = "models/weapons/w_snip_scar20_dropped.mdl"
...
class weapon_zone_repulsor(Weapon):
    model = "models/props_survival/repulsor/repulsor.mdl"
...
class molotov_projectile(TeamNum, Weapon):
    model = "models/weapons/w_eq_molotov.mdl"
...
class npc_heardanger(Targetname, Parentname, RenderFields, Shadow):
    def __init__(self):
        super(RenderFields).__init__()
        super(Targetname).__init__()
        super(Parentname).__init__()
...
class func_physbox_multiplayer(func_physbox):
    def __init__(self):
        super(func_physbox).__init__()

    @staticmethod
    def from_dict(instance, entity_data: dict):
        func_physbox.from_dict(instance, entity_data)


class func_buyzone(Targetname, TeamNum):
    def __init__(self):
        super(Targetname).__init__()
        super(TeamNum).__init__()
...
class func_bomb_target(Targetname, Parentname):
    def __init__(self):
        super(Targetname).__init__()
        super(Parentname).__init__()
        self.heistbomb = None  # Type: boolean
        self.bomb_mount_target = None  # Type: string

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Targetname.from_dict(instance, entity_data)
        Parentname.from_dict(instance, entity_data)
        instance.heistbomb = entity_data.get('heistbomb', None)  # Type: boolean
        instance.bomb_mount_target = entity_data.get('bomb_mount_target', None)  # Type: string
...
class Territory(Targetname, Angles):
    ...
    def __init__(self):
        super(Targetname).__init__()
        super(Angles).__init__()
        self.respawn_area = None  # Type: string
        self.buyzone = None  # Type: string

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Targetname.from_dict(instance, entity_data)
        Angles.from_dict(instance, entity_data)
        instance.respawn_area = entity_data.get('respawn_area', None)  # Type: string
        instance.buyzone = entity_data.get('buyzone', None)  # Type: string
...
class info_territory_control_hospital(Territory):
    ...
    def __init__(self):
        super(Territory).__init__()
        self.origin = [0, 0, 0]

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Territory.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
...
class game_money(Targetname):
    ...
    def __init__(self):
        super(Targetname).__init__()
        self.origin = [0, 0, 0]
        self.Money = 1000  # Type: integer
        self.AwardText = None  # Type: string

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Targetname.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.Money = parse_source_value(entity_data.get('money', 1000))  # Type: integer
        instance.AwardText = entity_data.get('awardtext', None)  # Type: string


class BaseVehicle(Targetname, prop_static_base, Origin, Global):
    def __init__(self):
        super(prop_static_base).__init__()
        super(Targetname).__init__()
        super(Origin).__init__()
...
class BaseDriveableVehicle(BaseVehicle):
    def __init__(self):
        ...
        self.VehicleLocked = None  # Type: boolean

    @staticmethod
    def from_dict(instance, entity_data: dict):
        BaseVehicle.from_dict(instance, entity_data)
        instance.VehicleLocked = entity_data.get('vehiclelocked', None)  # Type: boolean
...
class item_coop_coin(Targetname, Angles):
    model = "models/coop/challenge_coin.mdl"
...
class prop_exploding_barrel(Targetname, Angles):
    model = "models/props/coop_cementplant/exloding_barrel/exploding_barrel.mdl"
...
class func_nav_blocker(Targetname, Origin):
    def __init__(self):
        super(Targetname).__init__()
        super(Origin).__init__()
...
class skybox_swapper(Targetname):
    def __init__(self):
        super(Targetname).__init__()
        self.origin = [0, 0, 0]
        self.SkyboxName = "sky_dust"  # Type: string

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Targetname.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.SkyboxName = entity_data.get('skyboxname', "sky_dust")  # Type: string
...
class point_dz_weaponspawn(point_dz_itemspawn, Angles):
    model = "models/props_survival/cases/case_heavy_weapon.mdl"

    def __init__(self):
        super(point_dz_itemspawn).__init__()
        super(Angles).__init__()
        self.origin = [0, 0, 0]
        self.groupID = None  # Type: integer
        self.default_weight = 100  # Type: float
        self.door_name = None  # Type: string

    @staticmethod
    def from_dict(instance, entity_data: dict):
        point_dz_itemspawn.from_dict(instance, entity_data)
        Angles.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.groupID = parse_source_value(entity_data.get('groupid', 0))  # Type: integer
        instance.default_weight = float(entity_data.get('default_weight', 100))  # Type: float
...
class point_dz_weaponspawn_group(point_dz_itemspawn_group):
    def __init__(self):
        super(point_dz_itemspawn_group).__init__()
        self.origin = [0, 0, 0]

    @staticmethod
    def from_dict(instance, entity_data: dict):
        point_dz_itemspawn_group.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
...
class dangerzone_controller(Targetname):
    def __init__(self):
        super(Targetname).__init__()
        self.origin = [0, 0, 0]
        self.dz_enabled = 1  # Type: boolean
        self.dz_suppressbombalert = 1  # Type: boolean
        self.dz_missioncontrolled = 1  # Type: boolean

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Targetname.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.dz_enabled = entity_data.get('dz_enabled', None)  # Type: boolean
        instance.dz_suppressbombalert = entity_data.get('dz_suppressbombalert', None)  # Type: boolean
        instance.dz_missioncontrolled = entity_data.get('dz_missioncontrolled', None)  # Type: boolean
...
class point_dz_dronegun(Targetname, Angles):
    model = "models/props_survival/dronegun/dronegun.mdl"

    def __init__(self):
        super(Targetname).__init__()
        super(Angles).__init__()
        self.origin = [0, 0, 0]
        self.spawnAutomatically = "CHOICES NOT SUPPORTED"  # Type: choices
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Angles.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.spawnAutomatically = entity_data.get('spawnautomatically', "CHOICES NOT SUPPORTED")  # Type: choices


class point_dz_parachute(Targetname, Angles):
    model = "models/props_survival/upgrades/parachutepack.mdl"
...
class dz_door(DamageFilter, PropDoorRotating):
    def __init__(self):
        ...
        super(DamageFilter).__init__()
        self.origin = [0, 0, 0]
        self.is_security_door = None  # Type: boolean
    ...
    def from_dict(instance, entity_data: dict):
        ...
        PropDoorRotating.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.is_security_door = entity_data.get('is_security_door', None)  # Type: boolean


class prop_counter(Targetname, Angles, Parentname):
    model = "models/props_survival/counter/counter_a.mdl"
...
class vgui_world_text_panel(Targetname, Angles, Parentname):
    model = "models/editor/axis_helper_thick.mdl"
    ...
    def __init__(self):
        ...
        self.enabled = 1  # Type: boolean
        self.displaytext = None  # Type: string
        self.displaytextoption = None  # Type: string
        self.font = "DefaultLarge"  # Type: string
        self.width = 256  # Type: integer
        self.height = 128  # Type: integer
        self.textpanelwidth = 256  # Type: integer
        self.textcolor = [255, 255, 255]  # Type: color255
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.enabled = entity_data.get('enabled', None)  # Type: boolean
        instance.displaytext = entity_data.get('displaytext', None)  # Type: string
        instance.displaytextoption = entity_data.get('displaytextoption', None)  # Type: string
        instance.font = entity_data.get('font', "DefaultLarge")  # Type: string
        instance.width = parse_source_value(entity_data.get('width', 256))  # Type: integer
        instance.height = parse_source_value(entity_data.get('height', 128))  # Type: integer
        instance.textpanelwidth = parse_source_value(entity_data.get('textpanelwidth', 256))  # Type: integer
        instance.textcolor = parse_int_vector(entity_data.get('textcolor', "255 255 255"))  # Type: color255


class func_survival_c4_target(Targetname, Angles):
    model = "models/props_survival/safe/safe.mdl"

    def __init__(self):
        super(Targetname).__init__()
        super(Angles).__init__()
        self.origin = [0, 0, 0]
        self.radius = 350  # Type: float
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Angles.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.radius = float(entity_data.get('radius', 350))  # Type: float
...
class info_map_region(Base):
    def __init__(self):
        super().__init__()
        self.origin = [0, 0, 0]
        self.radius = 1200  # Type: float
        self.token = None  # Type: string

    @staticmethod
    def from_dict(instance, entity_data: dict):
        Base.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.radius = float(entity_data.get('radius', 1200))  # Type: float
        instance.token = entity_data.get('token', None)  # Type: string
...
class game_dz_coop_manager(Targetname, Parentname):
    def __init__(self):
        ...
        super(Parentname).__init__()
        self.origin = [0, 0, 0]
        self.configFile = None  # Type: string
    ...
    def from_dict(instance, entity_data: dict):
        ...
        Parentname.from_dict(instance, entity_data)
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.configFile = entity_data.get('configfile', None)  # Type: string


class prop_ammo_box_generic(Targetname, Parentname):
    model = "models/props_survival/crates/crate_ammobox.mdl"
...
class prop_weapon_upgrade_armor(Targetname, Parentname):
    model = "models/props_survival/upgrades/upgrade_dz_armor.mdl"
...
class prop_weapon_refill_heavyarmor(Targetname, Parentname):
    model = "models/props_survival/upgrades/upgrade_heavy_armor.mdl"
...
class prop_mapplaced_long_use_entity(Targetname, Angles, Parentname):
    def __init__(self):
        super(Targetname).__init__()
        super(Angles).__init__()
        super(Parentname).__init__()
        ...
        self.body = None  # Type: integer
        self.sequence = None  # Type: integer
        self.pingtype = None  # Type: choices
        self.longuseactiontype = None  # Type: choices
        self.longuseduration = None  # Type: float
        self.soundstartuse = None  # Type: string
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.body = parse_source_value(entity_data.get('body', 0))  # Type: integer
        instance.sequence = parse_source_value(entity_data.get('sequence', 0))  # Type: integer
        instance.pingtype = entity_data.get('pingtype', None)  # Type: choices
        instance.longuseactiontype = entity_data.get('longuseactiontype', None)  # Type: choices
        instance.longuseduration = float(entity_data.get('longuseduration', 0))  # Type: float
        instance.soundstartuse = entity_data.get('soundstartuse', None)  # Type: string


class weapon_mp5sd(Weapon):
    model = "models/weapons/w_smg_mp5sd.mdl"
...
class chicken(Global, SystemLevelChoice, Angles, BreakableProp, BaseFadeProp, Parentname, RenderFields):
    model = "models/chicken/chicken.mdl"
    ...
    def __init__(self):
        ...
        self.origin = [0, 0, 0]
        self.Health = 1  # Type: integer
        self.minhealthdmg = 1  # Type: integer
        self.glowdist = 1024  # Type: integer
        self.glowenabled = None  # Type: boolean
        self.glowcolor = [255, 255, 255]  # Type: color255
        self.glowstyle = None  # Type: choices
        self.skin = None  # Type: integer
        self.SetBodyGroup = None  # Type: choices
    ...
    def from_dict(instance, entity_data: dict):
        ...
        instance.origin = parse_float_vector(entity_data.get('origin', "0 0 0"))
        instance.Health = parse_source_value(entity_data.get('health', 1))  # Type: integer
        instance.minhealthdmg = parse_source_value(entity_data.get('minhealthdmg', 1))  # Type: integer
        instance.glowdist = parse_source_value(entity_data.get('glowdist', 1024))  # Type: integer
        instance.glowenabled = entity_data.get('glowenabled', None)  # Type: boolean
        instance.glowcolor = parse_int_vector(entity_data.get('glowcolor', "255 255 255"))  # Type: color255
        instance.glowstyle = entity_data.get('glowstyle', None)  # Type: choices
        instance.skin = parse_source_value(entity_data.get('skin', 0))  # Type: integer
        instance.SetBodyGroup = entity_data.get('setbodygroup', None)  # Type: choices


class point_camera(Angles, Parentname):
    viewport_model = "models/editor/camera.mdl"
